...
function cdBadges() {
  ...
  seneca.add(
    { role: plugin, cmd: 'listBadges' },
    listBadges({
      apiBaseUrl: options.apiBaseUrl,
      apiSecret: options.apiSecret,
      claimCodePrefix: options.claimCodePrefix,
    }),
  );
  seneca.add(
    { role: plugin, cmd: 'getBadge' },
    getBadge({ apiBaseUrl: options.apiBaseUrl, apiSecret: options.apiSecret }),
  );
  seneca.add(
    { role: plugin, cmd: 'deleteBadge' },
    deleteBadge({ apiBaseUrl: options.apiBaseUrl, apiSecret: options.apiSecret }),
  );
  seneca.add(
    { role: plugin, cmd: 'updateBadge' },
    updateBadge({ apiBaseUrl: options.apiBaseUrl, apiSecret: options.apiSecret }),
  );
  seneca.add(
    { role: plugin, cmd: 'createBadge' },
    createBadge({ apiBaseUrl: options.apiBaseUrl, apiSecret: options.apiSecret }),
  );
  ...
  seneca.add(
    { role: plugin, cmd: 'loadBadgeByCode' },
    loadBadgeByCode({ apiBaseUrl: options.apiBaseUrl, apiSecret: options.apiSecret }),
  );
  ...
  //  KPIs
  seneca.add(
    { role: plugin, cmd: 'kpiNumberOfBadgesAwarded' },
    kpiNumberOfBadgesAwarded.bind(seneca),
  );
  seneca.add(
    { role: plugin, cmd: 'kpiNumberOfBadgesPublished' },
